      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            <FileSearchOutlined style={{ fontSize: 26, color: '#fff' }} />
          </div>
        ...
        <div style={{ padding: '36px 40px 32px' }}>
          <Text style={{ color: '#444', fontSize: 15, fontWeight: 600, display: 'block', marginBottom: 20 }}>
          ...
          <Form form={form} onFinish={onFinish} layout="vertical" size="large">
            ...
            >
              <Input
                ...
                style={{ borderRadius: 10, height: 48, borderColor: '#ffe0cc' }}
              />
            </Form.Item>
            ...
            <Form.Item style={{ marginTop: 8, marginBottom: 16 }}>
              <Button
                ...
                style={{
                  ...
                  fontSize: 16,
                  fontWeight: 600,
                  boxShadow: '0 6px 20px rgba(230,62,0,0.35)',
                }}
              >
                Sign In
              </Button>
          ...
          <Divider style={{ borderColor: '#f5e6de', margin: '0 0 16px' }} />

          <div style={{ textAlign: 'center' }}>
            <Text style={{ color: '#999', fontSize: 14 }}>Don't have an account? </Text>
            <Link to="/register" style={{ color: '#ff6000', fontWeight: 600, fontSize: 14 }}>
              Sign up
            </Link>
          </div>
        </div>
